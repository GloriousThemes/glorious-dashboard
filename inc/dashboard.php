<div id="huro-app" class="app-wrapper">
                    ...
                    <div id="webapp-navbar-search" class="centered-search is-hidden">
                        <div class="field">
                            <div class="control has-icon">
                                <input type="text" class="input is-rounded" placeholder="Search records...">
                                <div class="form-icon">
                                    <i data-feather="search"></i>
                                </div>
        ...
        <!-- Content Wrapper -->
        <div id="user-profile" class="view-wrapper is-webapp" data-page-title="Profile Settings" data-naver-offset="214" data-menu-item="#layouts-navbar-menu" data-mobile-item="#home-sidebar-menu-mobile">
                    ...
                    <div class="page-content-inner">
                        ...
                        <div class="profile-wrapper">
                            <div class="profile-header has-text-centered">
                                ...
                                <p class="light-text">Hey everyone, Iam a product manager from New York and Iam looking for new
