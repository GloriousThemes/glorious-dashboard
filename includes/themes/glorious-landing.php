							...
							<div class="card widget-tweet">
								<div class="card-body">
									...
									<div class="widget-tweet-content">
										<p class="widget-tweet-text">Trying to define yourself is like trying to bite your own teeth.</p>
										<p class="widget-tweet-author">- Alan Watts</p>
									</div>
									</div>
								</div>
							</div>
									...
									<div class="card-body">
										...
										<div class="widget-payment-request-info m-t-md">
											...
											<div class="widget-payment-request-info-item">
												...
												<span class="text-muted d-block">Swift Transfer</span>
											</div>
										</div>
									...
									<div class="card-body">
										...
										<div class="widget-popular-blog-content ps-4">
											...
											<span class="widget-popular-blog-text">
												Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Mauris mattis, tellus sit amet volutpat porta
											</span>
										</div>
										</div>
									</div>
							...
							<div class="card widget widget-popular-product">
								<div class="card-body">
									...
									<div class="widget-popular-product-content">
										...
										<p class="widget-popular-product-text">Duis fringilla eget velit sit amet lobortis. Donec rutrum, arcu auctor varius cursus. mi nulla dapibus justo, at volutpat libero</p>
